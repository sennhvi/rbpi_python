...
class Player(pygame.sprite.Sprite):
    """The class that holds the main player, and controls how they jump. The player doesn't move left or right,
    the world moves around them"""

    def __init__(self, start_x, start_y, width, height):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.transform.scale(  # scale a image to specific width and height
...
class World:
    ...
    In the game, the world moves left and right rather than the player"""
...
# initialise pygame.mixer for music
...
bg_1_x = -100
bg_2_x = screen_x - 100  # for consistent background display

# update the display
pygame.display.update()

# each loop stands for a frame of game
while not finished:
    ...
    if world.at_goal(player.rect):
        print("Winner")
        finished = True
    # set the speed of loop, fps as arg
    clock.tick(20)
