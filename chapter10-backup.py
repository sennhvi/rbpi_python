...
# eg:
# scp file from client to server
# 1.use ssh-keygen -b 1024 -t rsa  to generate id_rsa and id_rsa.pub key pair
# no password entered means scp without password or passphrase
