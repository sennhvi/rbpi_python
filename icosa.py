...
# This program should run in Python2.7, in Python3.+ it will cause
# TypeError: No loop matching the specified signature and casting
# was found for ufunc true_divide due to integer division result
...
def make_sphere(level):
    ...
    def refine(vertices, indices):
        ...
        indices = numpy.vstack([numpy.column_stack(triple) for triple in
                                ((p0, p01, p02), (p01, p1, p12), (p01, p12, p02), (p12, p2, p02))])
